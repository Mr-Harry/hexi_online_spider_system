...
class AiManHuaCartoon:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        # url模板
        self.search_base_url = "http://www.manhuadq.cn/statics/search.aspx?key={}"


        # self.qin_quan_search_url_pre = "http://www.1manhua.net"
        # 详情页
        self.qin_quan_search_url_pre = "http://www.manhuadq.cn"
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            # 所有书的列表
            qin_quaq_list_data = response_data.xpath('/html/body/section[2]/div/ul/li/div/div[1]/h2/a')
            ...
            for q_l in qin_quaq_list_data:
                ...
                qin_quan_author_str = qin_quan_info_temp.xpath('./p[2]/a/text()')[0]# 侵权作者
                ...
                # 要改
                qin_quan_dict['qin_quan_platform_str'] = '漫画大全'  # 侵权平台

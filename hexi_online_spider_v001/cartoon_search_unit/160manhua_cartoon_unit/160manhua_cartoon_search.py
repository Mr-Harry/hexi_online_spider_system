...
class yiliulingManHuaCartoon:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        # url模板
        self.search_base_url = "https://www.mh160.xyz/statics/search.aspx?key={}&page={}"


        # self.qin_quan_search_url_pre = "http://www.1manhua.net"
        # 详情页
        self.qin_quan_search_url_pre = "https://www.mh160.xyz"

    # 搜索侵权
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["yiliulingmanhua_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["yiliulingmanhua_search_offset"]["start_page"]
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            # 所有书的列表
            qin_quaq_list_data = response_data.xpath('/html/body/div[2]/div[1]/div/div[2]/ul/li/div[2]/div/h4/a')
            ...
            for q_l in qin_quaq_list_data:
                ...
                # 要改
                qin_quan_dict['qin_quan_platform_str'] = '漫画160'  # 侵权平台
...
search_normals = yiliulingManHuaCartoon().search_qin_quan

...
class XiaoMuWu:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.headers = {
            ...
            'Host': 'manhua.zeo1.com',
            'Referer': 'http: // manhua.zeo1.com /',
            }
        self.api_qin_quan_search_key = ''
        self.search_base_url = "http://manhua.zeo1.com/plus/search.php?keyword={}&searchtype=titlekeyword&channeltype=0&orderby=&kwtype=0&typeid=0&PageNo={}"
        self.qin_quan_search_url_pre = "http://manhua.zeo1.com"
    #转意函数
    ...
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["xiaomuwu_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["xiaomuwu_search_offset"]["start_page"]
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            qin_quaq_list_data = response_data.xpath('//*[@id="main-content"]/div[2]/div[2]/section/div/div/ul/li/article/a')
            for q_l in qin_quaq_list_data:
                ...
                #     continue
                qin_quan_title_str = ''.join(qin_quan_info_data.xpath('//*[@id="post-header"]/h1/text()'))  # 侵权标题
                ...
                qin_quan_dict['qin_quan_platform_str'] = '小木屋'  # 侵权平台
...
search_normals = XiaoMuWu().search_qin_quan
if __name__ == "__main__":
    ...
    result = search_normals('%CE%DE', **yangben_dict)

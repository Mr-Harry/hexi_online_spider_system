...
class MangabzCartoon:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.headers = {
            ...
            'Referer': 'http://www.mangabz.com/search?title=1&page=1',
            'Accept-Language': 'zh-CN,zh;q=0.9',
            }
        self.api_qin_quan_search_key = ''
        self.search_base_url = "http://www.mangabz.com/search?title={}&page={}"
        self.qin_quan_info_url_pre = "http://www.mangabz.com"

    # 搜索侵权
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["mangabz_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["mangabz_search_offset"]["start_page"]
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            for q_l in qin_quaq_list_data:
                ...
                qin_quan_dict['qin_quan_platform_str'] = 'mangabz'  # 侵权平台
...
search_normals = MangabzCartoon().search_qin_quan

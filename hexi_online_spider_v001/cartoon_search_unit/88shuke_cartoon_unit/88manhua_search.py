...
class BaBaManHua:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "http://88sk.com/search/index/nickname/{}/p/{}.html"
        self.qin_quan_search_url_pre = "http://88sk.com"
    #转意函数
    ...
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["88manhua_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["88manhua_search_offset"]["start_page"]
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            qin_quaq_list_data = response_data.xpath('//div[@class="bookList_3"]/div[@class="item ib"]/a')
            for q_l in qin_quaq_list_data:
                ...
                qin_quan_info_temp = qin_quan_info_data.xpath("//div[@class='ib info']/p/span/a")[0]
                ...
                qin_quan_dict['qin_quan_platform_str'] = '88漫画'  # 侵权平台
...
search_normals = BaBaManHua().search_qin_quan

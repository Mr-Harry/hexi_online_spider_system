...
class AitaoManHuaCartoon:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        # url模板
        self.search_base_url = "http://www.hhimm.com/comic/?act=search&st={}"


        # self.qin_quan_search_url_pre = "http://www.1manhua.net"
        # 详情页
        self.qin_quan_search_url_pre = "http://www.hhimm.com"
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            # 所有书的列表
            qin_quaq_list_data = response_data.xpath('//*[@id="list"]/div[2]/li/a')
            ...
            for q_l in qin_quaq_list_data:
                ...
                try:
                    ...
                    continue
                qin_quan_info_temp = qin_quan_info_data.xpath('//*[@id="about_kit"]/ul/li[2]')[0]
                qin_quan_author_str = qin_quan_info_temp.xpath('./text()')[0]# 侵权作者
                ...
                # 要改
                qin_quan_dict['qin_quan_platform_str'] = '汗汗酷漫'  # 侵权平台

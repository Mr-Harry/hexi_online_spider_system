...
class ManHua57Cartoon:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "http://www.wuqimh.com/search/q_{}-p-{}"
        self.qin_quan_info_url_pre = "http://www.wuqimh.com"

    # 搜索侵权
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["manhua57_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["manhua57_search_offset"]["start_page"]
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            for q_l in qin_quaq_list_data:
                ...
                qin_quan_dict['qin_quan_platform_str'] = '57漫画网'  # 侵权平台
...
search_normals = ManHua57Cartoon().search_qin_quan

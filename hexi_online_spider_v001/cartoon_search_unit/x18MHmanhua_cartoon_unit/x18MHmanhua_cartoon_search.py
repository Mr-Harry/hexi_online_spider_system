...
class x18HuaCartoon:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        # url模板
        self.search_base_url = "https://mip.x18mh.com/statics/searchmip.aspx?key={}"


        # self.qin_quan_search_url_pre = "http://www.1manhua.net"
        # 详情页
        self.qin_quan_search_url_pre = "https://mip.x18mh.com"
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            # 所有书的列表
            qin_quaq_list_data = response_data.xpath('//*[@id="w0"]/ul/li/a[2]')
            ...
            for q_l in qin_quaq_list_data:
                ...
                # 要改
                qin_quan_dict['qin_quan_platform_str'] = 'x18漫画'  # 侵权平台
...
search_normals = x18HuaCartoon().search_qin_quan

...
class WuErErManHua:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "https://m.love127.com/statics/search.aspx?key={}"
        self.qin_quan_search_url_pre = "https://m.love127.com"
    #转意函数
    ...
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["522manhua_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["erciyuan_search_offset"]["start_page"]

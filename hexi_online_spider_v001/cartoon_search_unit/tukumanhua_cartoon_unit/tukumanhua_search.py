...
class TuKuManHua:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "http://www.tukucc.com/search/index/nickname/{}/p/{}.html"
        self.qin_quan_search_url_pre = "http://www.tukucc.com/"
    #转意函数
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            for q_l in qin_quaq_list_data:
                ...
                if qin_quan_info_data.xpath('//div[@class="ib info"]/p/span/a/text()'):
                    qin_quan_author_str = qin_quan_info_data.xpath('//div[@class="ib info"]/p/span/a/text()')[0]
                else:
                     qin_quan_author_str =''
...
search_normals = TuKuManHua().search_qin_quan

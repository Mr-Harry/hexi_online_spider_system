...
class QianWeiManHua:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "https://www.qianwee.com/search/?keywords={}&page={}"
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            qin_quaq_list_data = response_data.xpath('//li[@class="list-comic"]/a[@class="image-link"]')
            for q_l in qin_quaq_list_data:
                ...
                #     continue
                qin_quan_title_str = ''.join(qin_quan_info_data.xpath('///html/body/div[3]/div[1]/div[1]/div[2]/h1/text()'))  # 侵权标题
                ...
                qin_quan_dict['qin_quan_platform_str'] = '前未漫画'  # 侵权平台
...
search_normals = QianWeiManHua().search_qin_quan

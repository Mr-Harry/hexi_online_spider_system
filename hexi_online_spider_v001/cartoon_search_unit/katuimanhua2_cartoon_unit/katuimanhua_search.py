...
class KaTuiManHua:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "http://www.700mh.com/e/search/result/index.php?page={}&searchid=241"
        self.qin_quan_search_url_pre = "http://www.700mh.com"
    #转意函数
    ...
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["ktmanhua_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["ktmanhua_search_offset"]["start_page"]
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            for q_l in qin_quaq_list_data:
                ...
                qin_quan_author_str = qin_quan_info_data.xpath("//li[@class='twoCol']/text()")[0]
                ...
                qin_quan_dict['qin_quan_platform_str'] = '卡推漫画2'  # 侵权平台
...
search_normals = KaTuiManHua().search_qin_quan

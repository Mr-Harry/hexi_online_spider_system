...
class manhuakuManHuaCartoon:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        # url模板
        self.search_base_url = "http://www.manhuaku.cc/statics/search.aspx?key={}&page={}"


        # self.qin_quan_search_url_pre = "http://www.1manhua.net"
        # 详情页
        self.qin_quan_search_url_pre = "http://www.manhuaku.cc"
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            for q_l in qin_quaq_list_data:
                ...
                qin_quan_author_str = qin_quan_info_temp.xpath('./div[2]/p[2]/a/text()')[0]# 侵权作者
...
search_normals = manhuakuManHuaCartoon().search_qin_quan

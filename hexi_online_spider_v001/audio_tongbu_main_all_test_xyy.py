...
class audio_plarform_search():
    ...
    def get_search_task(self,tr_name): # 生成异步任务
        ...
        result_list = []
        task_info = redis_get_tasks_from_redis(task_name=config["redis_task_set_qq_name_bendi_test_xyy"],task_numbers=self.task_numbers) # 从redis 获取任务 接下来要进行判断 进行异步请求的包装

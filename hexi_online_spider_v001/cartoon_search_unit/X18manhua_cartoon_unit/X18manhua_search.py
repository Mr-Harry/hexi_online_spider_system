...
class X18manhua:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "https://www.x18mh.com/statics/search.aspx?key={}&page={}"
        self.qin_quan_search_url_pre = "https://www.x18mh.com"
    #转意函数
    ...
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["X18manhua_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["X18manhua_search_offset"]["start_page"]
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            for q_l in qin_quaq_list_data:
                ...
                qin_quan_info_temp = qin_quan_info_data.xpath('//div[@class="info"]/p/a')[0]
...
search_normals = X18manhua().search_qin_quan

...
class QiReManHua:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "https://www.qiremanhua.com/book/search/?key={}"
        self.qin_quan_search_url_pre = "https://www.qiremanhua.com"
    #转意函数
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            qin_quaq_list_data = response_data.xpath('//div[@class="title clearfix"]/a')
            for q_l in qin_quaq_list_data:
                ...
                qin_quan_info_temp = qin_quan_info_data.xpath('//div[@class="book-detail__author column"]/lable')[0]
                ...
                #     continue
                qin_quan_title_str = ''.join(qin_quan_info_data.xpath('//div[@class="book-detail__head clearfix"]/div[@class="title"]/text()'))  # 侵权标题
                ...
                qin_quan_dict['qin_quan_platform_str'] = '奇热漫画'  # 侵权平台
...
search_normals = QiReManHua().search_qin_quan

...
class ManBenDongMan:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "http://www.8jj.com/search?page={}&title={}"
        self.qin_quan_search_url_pre = "http://www.8jj.com"
    #转意函数
    ...
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["manbendongman_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["manbendongman_search_offset"]["start_page"]
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            qin_quaq_list_data = response_data.xpath('//div[@id="search_nrl"]/div[@class="ssnrk"]/div[@class="ssnr_bt"]/a')
            for q_l in qin_quaq_list_data:
                ...
                # qin_quan_info_temp = qin_quan_info_data.xpath('//div[@class="comic_deCon autoHeight"]/ul[@class="comic_deCon_liO"]/li')[0]
                    qin_quan_author_str = qin_quan_info_data.xpath("//div[@class='csly1z z']/a/text()")[2]
                except:
                    qin_quan_author_str = qin_quan_info_data.xpath("//div[@class='csly1z z']/a/text()")[1]
                ...
                qin_quan_dict['qin_quan_platform_str'] = '漫本动漫'  # 侵权平台
...
search_normals = ManBenDongMan().search_qin_quan

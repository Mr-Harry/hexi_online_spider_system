...
class JiuJiuWuManHUa:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "http://www.99wushu.com/statics/search.aspx?key={}&page={}"
        self.qin_quan_search_url_pre = "http://www.99wushu.com"
    #转意函数
    ...
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["jiujiuwushu_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["jiujiuwushu_search_offset"]["start_page"]
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            for q_l in qin_quaq_list_data:
                # xpath_demo = ''.join(q_l.xpath(''))title
                ...
                qin_quan_dict['qin_quan_platform_str'] = '久久wu叔漫画'  # 侵权平台
...
search_normals = JiuJiuWuManHUa().search_qin_quan

...
class AiManHuaCartoon:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        # url模板
        self.search_base_url = "https://www.imanhuaw.com/statics/search.aspx?key={}&page={}"


        # self.qin_quan_search_url_pre = "http://www.1manhua.net"
        # 详情页
        self.qin_quan_search_url_pre = "https://www.imanhuaw.com"
        ...
        try:
            ...
            for q_l in qin_quaq_list_data:
                ...
                try:
                    ...
                    continue
                qin_quan_info_temp = qin_quan_info_data.xpath('/html/body/div[3]')[0]
                qin_quan_author_str = qin_quan_info_temp.xpath('./div[2]/p[1]/span/em/a/text()')[0]# 侵权作者
                # print(qin_quan_author_str,'作者')
                # print(qin_quan_author_str)
                if not qin_quan_author_str:
                    continue
                qin_quan_title_str = ''.join(qin_quan_info_temp.xpath('./div[2]/div[1]/h4/a/text()'))  # 侵权标题
...
search_normals = AiManHuaCartoon().search_qin_quan

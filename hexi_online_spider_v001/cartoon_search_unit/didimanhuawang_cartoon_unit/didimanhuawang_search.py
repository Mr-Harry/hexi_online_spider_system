...
class DiDiManHuaWang:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "https://www.nfydd.com/statics/search.aspx?key={}"
        self.qin_quan_search_url_pre = "https://www.nfydd.com"
    #转意函数
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            for q_l in qin_quaq_list_data:
                ...
                qin_quan_info_temp = qin_quan_info_data.xpath('//div[@class="intro_l"]/div[@class="info"]/p/a')[0]
                ...
                qin_quan_dict['qin_quan_platform_str'] = '滴滴漫画网'  # 侵权平台
...
search_normals = DiDiManHuaWang().search_qin_quan

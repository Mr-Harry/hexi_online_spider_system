...
class BanCiYuan:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "https://bcy.net/search/all?k={}"
        self.qin_quan_search_url_pre = "https://bcy.net"
    #转意函数
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            # qin_quaq_list_data = response_data.xpath('//li[@class="js-smallCards _box"]/a/@href/text()')
            qin_quaq_list_data = response_data.xpath('//ul[@class="l-clearfix full smallCards"]/li[@class="js-smallCards _box"]/a[@class="db posr ovf"]')
            ...
            for q_l in qin_quaq_list_data:
                ...
                try:
                    ...
                    continue
                qin_quan_info_temp = qin_quan_info_data.xpath('//div[@class="user-name"]/a[@class="cut"]')[0]
                ...
                if not qin_quan_author_str:
                    continue
                # qin_quan_title_str = ''.join(qin_quan_info_data.xpath('//body/text()'))  # 侵权标题
                qin_quan_title_str = ''  # 侵权标题
                ...
                qin_quan_dict['qin_quan_platform_str'] = '半次元'  # 侵权平台
...
search_normals = BanCiYuan().search_qin_quan

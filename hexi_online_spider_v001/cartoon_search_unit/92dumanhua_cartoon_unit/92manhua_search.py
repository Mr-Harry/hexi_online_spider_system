...
class JiuErDuManHua:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "http://www.92du.com/search/index/nickname/{}/p/{}.html"
        self.qin_quan_search_url_pre = "http://www.92du.com"
    #转意函数
    ...
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["92manhua_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["92manhua_search_offset"]["start_page"]
        ...
        try:
            ...
            for q_l in qin_quaq_list_data:
                ...
                qin_quan_title_str = ''.join(
                    qin_quan_info_data.xpath('//div[@class="ib info"]/p[@class="title"]/text()'))  # 侵权标题
                ...
                qin_quan_dict['qin_quan_platform_str'] = '92漫画'  # 侵权平台
...
search_normals = JiuErDuManHua().search_qin_quan

...
class qisimanhuaCartoon:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        # url模板
        self.search_base_url = "https://www.qisimanhua.com/search/soft.html?q={}&PageIndex={}"


        # self.qin_quan_search_url_pre = "http://www.1manhua.net"
        # 详情页
        self.qin_quan_search_url_pre = "https://www.qisimanhua.com"
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            # 所有书的列表
            qin_quaq_list_data = response_data.xpath('/html/body/div[2]/div[1]/div[4]/ul/li')
            ...
            for q_l in qin_quaq_list_data:
                ...
                try:
                    ...
                    continue
                qin_quan_info_temp = qin_quan_info_data.xpath('/html/body/div[3]/div[1]/div[2]')[0]
                qin_quan_author_str = qin_quan_info_temp.xpath('/html/body/div[3]/div[1]/div[2]/div[2]/p/text()')[0]# 侵权作者
                ...
                # 要改
                qin_quan_dict['qin_quan_platform_str'] = '起司漫画'  # 侵权平台
...
search_normals = qisimanhuaCartoon().search_qin_quan

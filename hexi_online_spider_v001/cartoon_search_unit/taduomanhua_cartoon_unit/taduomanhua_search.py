...
class TaDuoManHua:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "http://www.taduo.net/e/search/result/?page={}&searchid={}"
        self.qin_quan_search_url_pre = "http://www.taduo.net/"
    ...
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["taduo_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["taduo_search_offset"]["start_page"]
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            qin_quaq_list_data = response_data.xpath('//p[@class="fl cover"]/a')
            ...
            for q_l in qin_quaq_list_data:
                ...
                try:
                    ...
                    continue
                qin_quan_info_temp = qin_quan_info_data.xpath('//li[@class="twoCol"]') [1]
                ...
                if not qin_quan_author_str:
                    continue
                qin_quan_title_str = ''.join(qin_quan_info_data.xpath('//div[@class="titleInfo"]/h1/text()'))  # 侵权标题
                ...
                qin_quan_dict['qin_quan_platform_str'] = '塔多漫画'  # 侵权平台
...
search_normals = TaDuoManHua().search_qin_quan
if __name__ == "__main__":
    ...
    result = search_normals('3535', **yangben_dict)

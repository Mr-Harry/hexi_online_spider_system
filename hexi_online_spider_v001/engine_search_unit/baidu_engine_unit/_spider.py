...
from audio_tool import unify_requests
from engine_search_unit.baidu_engine_unit.errors import ParseError, UnknownError
...
class BaseSpider(object):  # pragma: no cover
    ...
    def _get_response(self, url: str) -> str:
        ...
        Returns:
            str: 获取到的网站HTML代码
        """
        response = unify_requests(url=url, headers=self.headers)

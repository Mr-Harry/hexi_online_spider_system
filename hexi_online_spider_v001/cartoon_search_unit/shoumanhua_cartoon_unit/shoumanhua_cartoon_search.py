...
class shouManHuaCartoon:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        # url模板
        self.search_base_url = "http://www.shoumanhua.com/statics/search.aspx?key={}&button=1"


        # self.qin_quan_search_url_pre = "http://www.1manhua.net"
        # 详情页
        self.qin_quan_search_url_pre = "http://www.shoumanhua.com"
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            for q_l in qin_quaq_list_data:
                ...
                # 要改
                qin_quan_dict['qin_quan_platform_str'] = '受漫画'  # 侵权平台
...
search_normals = shouManHuaCartoon().search_qin_quan

...
class SouManHua:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "http://www.somanhua.com/search/index/nickname/{}/p/{}.html"
        self.qin_quan_search_url_pre = "http://www.somanhua.com"
    ...
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["soumanhua_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["soumanhua_search_offset"]["start_page"]
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            qin_quaq_list_data = response_data.xpath('//div[@class="item ib"]/a')
            ...
            for q_l in qin_quaq_list_data:
                ...
                try:
                    ...
                    continue
                qin_quan_info_temp = qin_quan_info_data.xpath('//span[@class="ib l"]/a')[0]
                ...
                if not qin_quan_author_str:
                    continue
                qin_quan_title_str = ''.join(qin_quan_info_data.xpath('//div[@class="ib info"]/p[@class="title"]/text()'))  # 侵权标题
                ...
                qin_quan_dict['qin_quan_platform_str'] = '搜漫画'  # 侵权平台
...
search_normals = SouManHua().search_qin_quan

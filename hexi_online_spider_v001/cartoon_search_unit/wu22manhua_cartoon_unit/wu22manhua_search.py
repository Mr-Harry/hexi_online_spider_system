...
class WuErErManHua:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "https://www.love127.com/statics/search.aspx?key={}&page={}"
        self.qin_quan_search_url_pre = "https://www.love127.com"
    #转意函数
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            qin_quaq_list_data = response_data.xpath('//div[@class="cy_list_mh"]/ul/li[@class="updata"]/a')
            for q_l in qin_quaq_list_data:
                ...
                qin_quan_dict['qin_quan_platform_str'] = '522漫画'  # 侵权平台
...
search_normals = WuErErManHua().search_qin_quan

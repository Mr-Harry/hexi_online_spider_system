...
class TuTuManHua:
    def __init__(self, use_proxy=CARTOON_CONF.get('search_use_proxy')):
        ...
        self.search_base_url = "https://www.tutumanhua.com/statics/search.aspx?key={}&page={}"
        self.qin_quan_search_url_pre = "https://www.tutumanhua.com"
    #转意函数
    ...
    def search_qin_quan(self, search_key: str, **kwargs):
        _page = kwargs.get("page_num") + CARTOON_CONF["tutu1manhua_search_offset"]["start_page"] - 1 if kwargs.get("page_num") else CARTOON_CONF["tutu1manhua_search_offset"]["start_page"]
    ...
    def parse_search_qin_quan(self, response, **kwargs) -> list:
        try:
            ...
            for q_l in qin_quaq_list_data:
                ...
                qin_quan_dict['qin_quan_platform_str'] = '兔兔漫画'  # 侵权平台
...
search_normals = TuTuManHua().search_qin_quan
